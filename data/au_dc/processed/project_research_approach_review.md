...
- CDC Marsden Park: NSW Planning Portal states current status "Determination" and describes 504MW power consumption plus a 720MW substation. The seed now records this as an approved row with `capacity_basis=power_consumption_mw`, not construction/IT load. Source: https://www.planningportal.nsw.gov.au/major-projects/projects/marsden-park-data-centre
